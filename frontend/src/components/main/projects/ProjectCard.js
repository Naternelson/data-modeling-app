...
const ProjectCard = props => {
    ...
    const beginBtn = <Btn onClick={beginClick} value={"Begin"}/>
    const pauseBtn = <Btn onClick={pauseClick} value={"Pause"}/>
    const deleteBtn = <Btn onClick={deleteClick} value={"Delete"}/>
